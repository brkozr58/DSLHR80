...
*   generation date: 30.09.2025 at 13:23:46
...
IF STATUS_/DSL/HR80_V004-ST_DELETE EQ GELOESCHT.
  ...
  PERNR = /DSL/HR80_V004-PERNR AND
  LGART = /DSL/HR80_V004-LGART .
    IF SY-SUBRC = 0.
...
FORM GET_DATA_/DSL/HR80_V013.
  PERFORM VIM_FILL_WHERETAB.
*.read data from database.............................................*
  REFRESH TOTAL.
  CLEAR   TOTAL.
  SELECT * FROM /DSL/HR80_T013 WHERE
(VIM_WHERETAB) .
    CLEAR /DSL/HR80_V013 .
/DSL/HR80_V013-MANDT =
/DSL/HR80_T013-MANDT .
...
/DSL/HR80_T013-AUART .
    SELECT SINGLE * FROM /DSL/HR80_T001 WHERE
GRPID = /DSL/HR80_T013-GRPID AND
MOLGA = /DSL/HR80_T013-MOLGA .
    IF SY-SUBRC EQ 0.
/DSL/HR80_V013-GRPID_T =
/DSL/HR80_T001-GRPID_T .
    ENDIF.
    SELECT * FROM /DSL/HR80_T003 WHERE
GRPID = /DSL/HR80_T013-GRPID AND
VRSID = /DSL/HR80_T013-VRSID AND
MOLGA = /DSL/HR80_T013-MOLGA .
/DSL/HR80_V013-VRSID_T =
/DSL/HR80_T003-VRSID_T .
      EXIT.
    ENDSELECT.
    SELECT SINGLE * FROM T512W WHERE
MOLGA = /DSL/HR80_T013-MOLGA AND
LGART = /DSL/HR80_T013-LGART AND
ENDDA = /DSL/HR80_T013-ENDDA .
    IF SY-SUBRC EQ 0.
      SELECT SINGLE * FROM T512T WHERE
MOLGA = T512W-MOLGA AND
LGART = T512W-LGART AND
...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_/DSL/HR80_V013 .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO /DSL/HR80_V013.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_/DSL/HR80_V013-ST_DELETE EQ GELOESCHT.
     READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
     IF SY-SUBRC EQ 0.
       DELETE EXTRACT INDEX SY-TABIX.
     ENDIF.
    ...
    ENDIF.
   WHEN GELOESCHT.
  SELECT SINGLE FOR UPDATE * FROM /DSL/HR80_T013 WHERE
  MOLGA = /DSL/HR80_V013-MOLGA AND
  GRPID = /DSL/HR80_V013-GRPID AND
  VRSID = /DSL/HR80_V013-VRSID AND
  BUKRS = /DSL/HR80_V013-BUKRS AND
  LGART = /DSL/HR80_V013-LGART AND
  SEQNO = /DSL/HR80_V013-SEQNO AND
  ENDDA = /DSL/HR80_V013-ENDDA .
    IF SY-SUBRC = 0.
    DELETE /DSL/HR80_T013 .
    ENDIF.
    IF STATUS-DELETE EQ GELOESCHT.
      READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY> BINARY SEARCH.
      DELETE EXTRACT INDEX SY-TABIX.
...
/DSL/HR80_V013-AUART .
    IF SY-SUBRC = 0.
    UPDATE /DSL/HR80_T013 ##WARN_OK.
    ELSE.
    INSERT /DSL/HR80_T013 .
    ENDIF.
    READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
    IF SY-SUBRC EQ 0.
      <XACT> = ORIGINAL.
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_/DSL/HR80_V013-UPD_FLAG,
STATUS_/DSL/HR80_V013-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_/DSL/HR80_V013.
  SELECT SINGLE * FROM /DSL/HR80_T013 WHERE
MOLGA = /DSL/HR80_V013-MOLGA AND
GRPID = /DSL/HR80_V013-GRPID AND
VRSID = /DSL/HR80_V013-VRSID AND
BUKRS = /DSL/HR80_V013-BUKRS AND
...
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_/DSL/HR80_V013 USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE /DSL/HR80_V013-MOLGA TO
/DSL/HR80_T013-MOLGA .
MOVE /DSL/HR80_V013-GRPID TO
/DSL/HR80_T013-GRPID .
MOVE /DSL/HR80_V013-VRSID TO
/DSL/HR80_T013-VRSID .
MOVE /DSL/HR80_V013-BUKRS TO
/DSL/HR80_T013-BUKRS .
MOVE /DSL/HR80_V013-LGART TO
/DSL/HR80_T013-LGART .
MOVE /DSL/HR80_V013-SEQNO TO
/DSL/HR80_T013-SEQNO .
MOVE /DSL/HR80_V013-ENDDA TO
/DSL/HR80_T013-ENDDA .
MOVE /DSL/HR80_V013-MANDT TO
/DSL/HR80_T013-MANDT .
  CORR_KEYTAB             =  E071K.
  CORR_KEYTAB-OBJNAME     = '/DSL/HR80_T013'.
  IF NOT <vim_corr_keyx> IS ASSIGNED.
    ASSIGN CORR_KEYTAB-TABKEY TO <vim_corr_keyx> CASTING.
  ENDIF.
  ASSIGN /DSL/HR80_T013 TO <TAB_KEY_X> CASTING.
  PERFORM VIM_GET_TRSPKEYLEN
    USING '/DSL/HR80_T013'
    CHANGING TRSP_KEYLEN.
  <VIM_CORR_KEYX>(TRSP_KEYLEN) = <TAB_KEY_X>(TRSP_KEYLEN).
...
ENDFORM.
*---------------------------------------------------------------------*
FORM COMPL_/DSL/HR80_V013 USING WORKAREA.
*      provides (read-only) fields from secondary tables related
*      to primary tables by foreignkey relationships
/DSL/HR80_T013-MANDT =
/DSL/HR80_V013-MANDT .
...
FORM GET_DATA_/DSL/HR80_V014.
  PERFORM VIM_FILL_WHERETAB.
*.read data from database.............................................*
  REFRESH TOTAL.
  CLEAR   TOTAL.
  SELECT * FROM /DSL/HR80_T014 WHERE
(VIM_WHERETAB) .
    CLEAR /DSL/HR80_V014 .
/DSL/HR80_V014-MANDT =
/DSL/HR80_T014-MANDT .
...
/DSL/HR80_T014-KONTH .
    SELECT SINGLE * FROM /DSL/HR80_T001 WHERE
GRPID = /DSL/HR80_T014-GRPID AND
MOLGA = /DSL/HR80_T014-MOLGA .
    IF SY-SUBRC EQ 0.
/DSL/HR80_V014-GRPID_T =
/DSL/HR80_T001-GRPID_T .
    ENDIF.
    SELECT * FROM /DSL/HR80_T003 WHERE
GRPID = /DSL/HR80_T014-GRPID AND
VRSID = /DSL/HR80_T014-VRSID AND
MOLGA = /DSL/HR80_T014-MOLGA .
/DSL/HR80_V014-VRSID_T =
/DSL/HR80_T003-VRSID_T .
      EXIT.
    ENDSELECT.
    SELECT SINGLE * FROM T500L WHERE
MOLGA = /DSL/HR80_T014-MOLGA .
    IF SY-SUBRC EQ 0.
    ENDIF.
<VIM_TOTAL_STRUC> = /DSL/HR80_V014.
    APPEND TOTAL.
  ENDSELECT.
  SORT TOTAL BY <VIM_XTOTAL_KEY>.
  <STATUS>-ALR_SORTED = 'R'.
...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_/DSL/HR80_V014 .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO /DSL/HR80_V014.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_/DSL/HR80_V014-ST_DELETE EQ GELOESCHT.
     READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
     IF SY-SUBRC EQ 0.
       DELETE EXTRACT INDEX SY-TABIX.
     ENDIF.
    ...
    ENDIF.
   WHEN GELOESCHT.
  SELECT SINGLE FOR UPDATE * FROM /DSL/HR80_T014 WHERE
  MOLGA = /DSL/HR80_V014-MOLGA AND
  GRPID = /DSL/HR80_V014-GRPID AND
  VRSID = /DSL/HR80_V014-VRSID AND
  KTOPL = /DSL/HR80_V014-KTOPL AND
  KTOSL = /DSL/HR80_V014-KTOSL AND
  BWMOD = /DSL/HR80_V014-BWMOD AND
  KOMOK = /DSL/HR80_V014-KOMOK AND
  BKLAS = /DSL/HR80_V014-BKLAS .
    IF SY-SUBRC = 0.
    DELETE /DSL/HR80_T014 .
    ENDIF.
    IF STATUS-DELETE EQ GELOESCHT.
      READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY> BINARY SEARCH.
      DELETE EXTRACT INDEX SY-TABIX.
...
/DSL/HR80_V014-KONTH .
    IF SY-SUBRC = 0.
    UPDATE /DSL/HR80_T014 ##WARN_OK.
    ELSE.
    INSERT /DSL/HR80_T014 .
    ENDIF.
    READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
    IF SY-SUBRC EQ 0.
      <XACT> = ORIGINAL.
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_/DSL/HR80_V014-UPD_FLAG,
STATUS_/DSL/HR80_V014-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_/DSL/HR80_V014.
  SELECT SINGLE * FROM /DSL/HR80_T014 WHERE
MOLGA = /DSL/HR80_V014-MOLGA AND
GRPID = /DSL/HR80_V014-GRPID AND
VRSID = /DSL/HR80_V014-VRSID AND
KTOPL = /DSL/HR80_V014-KTOPL AND
...
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_/DSL/HR80_V014 USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE /DSL/HR80_V014-MOLGA TO
/DSL/HR80_T014-MOLGA .
MOVE /DSL/HR80_V014-GRPID TO
/DSL/HR80_T014-GRPID .
MOVE /DSL/HR80_V014-VRSID TO
/DSL/HR80_T014-VRSID .
MOVE /DSL/HR80_V014-KTOPL TO
/DSL/HR80_T014-KTOPL .
MOVE /DSL/HR80_V014-KTOSL TO
/DSL/HR80_T014-KTOSL .
MOVE /DSL/HR80_V014-BWMOD TO
/DSL/HR80_T014-BWMOD .
MOVE /DSL/HR80_V014-KOMOK TO
/DSL/HR80_T014-KOMOK .
MOVE /DSL/HR80_V014-BKLAS TO
/DSL/HR80_T014-BKLAS .
MOVE /DSL/HR80_V014-MANDT TO
/DSL/HR80_T014-MANDT .
  CORR_KEYTAB             =  E071K.
  CORR_KEYTAB-OBJNAME     = '/DSL/HR80_T014'.
  IF NOT <vim_corr_keyx> IS ASSIGNED.
    ASSIGN CORR_KEYTAB-TABKEY TO <vim_corr_keyx> CASTING.
  ENDIF.
  ASSIGN /DSL/HR80_T014 TO <TAB_KEY_X> CASTING.
  PERFORM VIM_GET_TRSPKEYLEN
    USING '/DSL/HR80_T014'
    CHANGING TRSP_KEYLEN.
  <VIM_CORR_KEYX>(TRSP_KEYLEN) = <TAB_KEY_X>(TRSP_KEYLEN).
...
ENDFORM.
*---------------------------------------------------------------------*
FORM COMPL_/DSL/HR80_V014 USING WORKAREA.
*      provides (read-only) fields from secondary tables related
*      to primary tables by foreignkey relationships
/DSL/HR80_T014-MANDT =
/DSL/HR80_V014-MANDT .

...
PARAMETERS: p_schema  TYPE  t52cd-sname .
PARAMETERS: p_vari   TYPE vari-variant ."DEFAULT '/DSL/HR80' .

SELECTION-SCREEN PUSHBUTTON 50(42) chlogvar
                USER-COMMAND chal VISIBLE LENGTH 4.

SELECTION-SCREEN END OF BLOCK bl3.

SELECTION-SCREEN BEGIN OF BLOCK bl4  WITH FRAME .

SELECTION-SCREEN PUSHBUTTON 1(30) chnge
                USER-COMMAND chng  .

SELECTION-SCREEN PUSHBUTTON 35(30) py_job
                USER-COMMAND pyj  .

SELECTION-SCREEN PUSHBUTTON 70(30) job_log
                USER-COMMAND pjl  .
...
CLASS lcl_report DEFINITION   .
  ...
  PUBLIC SECTION.
    ...
    METHODS :
          ...
          at_selection_screen,
          f4_popup_schema IMPORTING
                            molga     TYPE molga
                          CHANGING
                            schema      TYPE t52cd-sname,

         f4_popup_p_vanam CHANGING
                            p_vanam  TYPE hrplog_varkey-vanam,

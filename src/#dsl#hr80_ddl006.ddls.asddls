...
define view /DSL/HR80_CDS006
  with parameters
    ...
    p_date : abap.dats
  //
  as select from    /dsl/hr80_ddl001 as person
  //
    inner join      /dsl/hr80_ddl005 as payroll on  payroll.molga = person.molga
  ...
  //
    inner join      /dsl/hr80_t013   as t013    on  t013.bukrs =  person.bukrs
                                                ...
                                                and t013.endda >= $parameters.p_date
    //                                                and t013.endda >= $session.system_date
                                                and t013.spprc <> 'P'
  ...
  //
{
  ...
  //
  //
  cast ( coalesce(HRC.ktosl,HRF.ktosl ) as ktosl )                         as ktosl,
  cast ( coalesce(HRC.konts,HRF.konts ) as saknr )                         as konts,
  //
  //
